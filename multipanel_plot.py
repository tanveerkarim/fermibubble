...
#Read FITS files
g130m = np.genfromtxt('Sightlines/PKS2005-489/PKS2005-489_spec-G130M.gz')
g160m = np.genfromtxt('Sightlines/PKS2005-489/PKS2005-489_spec-G160M.gz')

#Read GASS HI spectra file
gass = np.genfromtxt('Sightlines/PKS2005-489/PKS2005-489_HIsp-GASS.dat')
...
high1 = -300  #upper bound for continuum fit on the left side
